...
//     const getConnectionNode = ({ handleRetry, type }: { handleRetry: () => void, type?: string }) => {
//         if (!type) {
//             if (!isActiveTimed && isConnecting) {
//                 return <ConnectingSection onCancel={handleCancelTimeout} />
//             } else if (isActiveTimed && isConnecting) {
//                 return <FailedConnectionSection onRetry={handleRetry} onCancel={cancelConnection}/>
//             }
//             return <ConnectingSection onCancel={handleCancelTimeout} />
//         }
//         if (type === "CREATE/JOIN") {
//             return <CodeInput code={code} set />
//         }
//     }
...
//     //             maxLength={6} minLength={6} value={code}
//     //             onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
//     //                 if (code.trim().length < 6) setCode((event.target.value).trim());
//     //             }} />
//     //         <Button onClick={createOrJoinMatch}>Proceed</Button>
//     //     </section>
//     // )
...
//         setIsConnecting(true);
//         setActiveTimed(false);
//         const cancel = () => cancelCreateOrJoinMatch(address, code);
//         startConnectionTimeout(cancel);
//         setModalProps({
//             body: getConnectionNode({handleRetry: handleRetryQuickMatch, type:'CREATE/JOIN'}),
//             isOpen: true,
